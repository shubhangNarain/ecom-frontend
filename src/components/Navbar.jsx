  ...
  return (
    <>
      ...
      <div className="bg-black text-accent text-center py-2.5 px-8 font-display text-[0.72rem] font-semibold tracking-[0.12em] uppercase">
        ⚡ Free shipping on orders over $99 &nbsp;|&nbsp; New arrivals every
        week &nbsp;|&nbsp; Use code TECH20 for 20% off
      </div>
      ...
      <nav className="sticky top-0 z-50 bg-white/95 backdrop-blur-xl border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-8 flex items-center justify-between h-[72px] gap-8">
          ...
          <Link
            to="/"
            className="font-display text-[1.6rem] font-bold tracking-tight text-black shrink-0"
          >
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative hidden md:block h-10 w-10">
              <motion.div
                animate={{ width: searchOpen ? 256 : 40 }}
                transition={{ duration: 0.4, ease: [0.25, 0.46, 0.45, 0.94] }}
                className={`absolute right-0 flex items-center h-10 rounded-full overflow-hidden transition-colors transition-shadow duration-350 z-20
