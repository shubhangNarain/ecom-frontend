            ...
            <div className="flex-1 overflow-y-auto px-8 py-6 custom-scrollbar">
              {cart.length === 0 ? (
                <div className="h-full flex flex-col items-center justify-center text-center opacity-40">
                  ...
                  <p className="font-display font-medium text-lg mb-8 uppercase tracking-widest">
                    Bag is Empty
                  </p>
                  <button
                    onClick={() => setIsCartOpen(false)}
                      ...
                      <div className="flex-1 flex flex-col justify-between py-1">
                        <div>
                          <div className="flex justify-between items-start mb-1">
                            <h3 className="font-display font-bold text-sm uppercase tracking-tight line-clamp-1">
                              {item.name}
                            </h3>
                            <button
            ...
            {cart.length > 0 && (
              <div className="p-8 bg-gray-50 border-t border-gray-100">
                ...
                <button 
                  ...
                  className="w-full bg-black text-white py-5 rounded-2xl font-display font-bold text-sm uppercase tracking-[0.2em] hover:bg-accent hover:text-black transition-all flex items-center justify-center gap-3 group"
                >
                  Proceed to Checkout
                  <ArrowRight
                    size={18}
