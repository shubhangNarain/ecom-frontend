...
const CATEGORIES = ['All', 'Audio', 'Wearables', 'Computers', 'Photography', 'Gaming'];
    ...
    <div className="min-h-screen bg-white pt-32 pb-24">
      <div className="max-w-7xl mx-auto px-8">
        ...
        <div className="mb-8 flex items-center gap-2">
          ...
          <span className="font-display font-bold text-black">{sortedProducts.length}</span>
        ...
        <AnimatePresence mode="popLayout">
          {sortedProducts.length > 0 ? (
            ...
            >
              ...
              <h3 className="font-display text-2xl font-bold mb-2">No matching products</h3>
