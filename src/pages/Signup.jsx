      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 text-sm">
            Join us for exclusive drops and fast checkout.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button
            ...
            className="w-full bg-black text-white py-4 rounded-xl font-display font-bold text-sm uppercase tracking-[0.15em] hover:bg-accent hover:text-black transition-all flex items-center justify-center gap-3 group mt-6 disabled:opacity-70 disabled:cursor-not-allowed"
          >
            {isSubmitting ? (
