    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            >
              ...
              >
                <p className="text-black font-display font-bold text-lg mb-2 italic">
                  AURA Series
                </p>
                <p className="text-gray-400 text-xs leading-5">
                  Our flagship audio line redefined how we interact with sound
                  in shared spaces.
                </p>
              </motion.div>
            </motion.div>
            ...
            <div>
              <h2 className="font-display font-bold text-3xl text-black mb-8 tracking-tight italic">
                Beyond the Specification.
              </h2>
              <p className="text-gray-500 text-lg leading-8 mb-8">
                At Jauter, we believe that technology should feel as natural as
                the spaces it inhabits. We don't just build electronics; we
                craft experiences that bridge the gap between digital power and
                human intuition.
              </p>
                ...
                {[
                  {
                    ...
                    title: 'Precision',
                    desc: 'Every curve and component is intentional.',
                  },
                  {
                    icon: <Zap className="text-accent" />,
                    title: 'Innovation',
                    desc: 'Pushing boundaries without complexity.',
                  },
                  {
                    icon: <Shield className="text-accent" />,
                    title: 'Reliability',
                    desc: 'Built to last in a fast-paced world.',
                  },
                  {
                    icon: <Heart className="text-accent" />,
                    title: 'Purpose',
                    desc: 'Tech that serves you, not the other way around.',
                  },
                ].map((val, i) => (
                  <motion.div
                    key={i}
                  ...
                  >
                    ...
                    <h3 className="font-display font-bold text-black mb-2 uppercase text-xs tracking-widest">
                      {val.title}
                    </h3>
        ...
        <div className="max-w-7xl mx-auto px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-12 text-center lg:text-left">
            {[
              ...
              <div key={i}>
                <p className="text-accent font-display font-black text-[3rem] lg:text-[4rem] leading-none mb-2 italic">
                  {s.val}
                </p>
                <p className="text-gray-400 font-display font-bold text-[0.7rem] uppercase tracking-widest">
                  {s.label}
                </p>
              </div>
            ))}
      ...
      <section className="py-24 bg-black text-white relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-8 text-center relative z-10">
          <h2 className="font-display font-bold text-[2.5rem] lg:text-[3.5rem] tracking-tight mb-12">
            The Future is <span className="text-accent italic">Tactile</span>.
          </h2>
          <p className="text-gray-400 text-xl leading-relaxed mb-16">
            We are a collective of designers, engineers, and dreamers based
            globally, united by a single goal: to make premium technology
